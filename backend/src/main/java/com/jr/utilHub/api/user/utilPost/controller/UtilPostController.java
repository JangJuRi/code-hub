...
import com.jr.utilHub.api.user.utilPost.dto.UtilPostSaveDto;
...
public class UtilPostController {
    ...
    @GetMapping("/user/util-post/list/{utilPostMasterId}/{language}/load")
    ...
    @GetMapping("/user/util-post/detail/{utilPostId}/load")
